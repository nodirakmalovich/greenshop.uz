      ...
      <div className="ShopHero flex flex-wrap md:flex-nowrap items-center justify-center md:justify-between gap-[52px] mt-[50px]">
        <div className="left w-full md:w-[50%]">
          <ProductCard
            ...
            mainImageAlt={selectedItem ? selectedItem.name : 'You have not selected a product yet.'}
            leftImageAlt={selectedItem ? selectedItem.name : 'You have not selected a product yet.'}
          />
        </div>
